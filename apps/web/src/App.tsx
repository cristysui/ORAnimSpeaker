...
import { ProjectDashboard, rememberProject } from "./components/project/ProjectDashboard";
...
function App() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => rememberProject(project), 600);
    return () => window.clearTimeout(timer);
  }, [project, route]);

  const showDashboard = ["welcome", "templates", "recent"].includes(route);
